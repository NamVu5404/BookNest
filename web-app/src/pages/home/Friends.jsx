...
export default function Friends() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await getAllFriends(userId, lastUserId, limit);
        ...
        console.error("Fail to fetch friend list:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div style={{ fontSize: 15 }}>
      <h3 style={{ marginBottom: 16, fontSize: 20 }}>Tất cả bạn bè</h3>
