...
import {Avatar, Button, message, Modal, Space, Timeline, Tooltip, Typography} from "antd";
...
const Post = forwardRef((props, ref) => {
    const {userId, avatar, fullName, elapsedTime, content, createdDate, modifiedDate} = props.post;
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                const response = await getPostHistory(props.post.id, 1, Number.MAX_SAFE_INTEGER);
        ...
        >
            ...
            >
                ...
                <div style={{display: "flex", flexDirection: "row", alignItems: "center"}}>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            {(createdDate !== modifiedDate) && <Text type="secondary" style={{fontSize: "12px"}}>
                                {" "}(Đã chỉnh sửa)
                            </Text>}
                        </div>
                    </div>
                ...
                <Space>
                    ...
                    {postHistory.length !== 0 && <Tooltip title="Lịch sử chỉnh sửa">
                        <Button
                            type="default"
